# Generated by Django 4.2.13 on 2025-06-14 22:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_document_url', models.CharField(blank=True, max_length=255, null=True, verbose_name='ID document URL')),
                ('user_type', models.CharField(choices=[('investor', 'Investor'), ('entrepreneur', 'Entrepreneur')], db_index=True, default='investor', max_length=12, verbose_name='user type')),
