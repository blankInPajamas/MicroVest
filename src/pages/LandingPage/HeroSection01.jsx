            ...
            <section className="flex items-center justify-center min-h-[40rem] bg-gray-100">
                <div className="container mx-w-6xl px-6 py-12 flex flex-col md:flex-row items-center justify-between">
                    <div className="text-left md:w-1/2 md:pr-12 mb-10 md:mb-0">
                        ...
                        <Link to="/signup" className="bg-black text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-gray-300 hover:text-gray-900 hover:border-black hover:border-1 transition duration-300 flex items-center w-60">
                    ...
                    <div className="md:w-1/2 flex justify-center md:justify-end">
                        ...
                        <img
                            ...
                            className="w-full h-auto rounded-lg shadow-xl object-cover  scale-125"
                        />
                        </div>
                    </div>
                </div>
