...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    if (storedAuthToken && storedUsername) {
      console.log('Profile: Setting user as authenticated');
      const userData = {
      ...
      console.log('Profile: Missing required data, user not authenticated');
    }
                  ...
                  <div className="flex-1">
                    ...
                    {isEditing ? (
                      <input
                        ...
                        className={`mt-1 w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 ${
